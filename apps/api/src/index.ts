  ...
  return buildApiServer({
    ...
    featureEnvironment: {
      ...
      connectionProviders: (["github", "google_drive"] as const)
        .filter((provider) => runtime.connectionProviders.configured(provider)).length,
    },
    ...
    missionIntelligenceService: runtime.missionIntelligenceService,
    continuousMissionService: runtime.continuousMissionService,
